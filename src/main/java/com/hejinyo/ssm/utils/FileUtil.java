...
public class FileUtil {
     ...
     * @return
     */
    public static String getFilePathInWeb(String folderName){
        String filePath = System.getProperty("user.dir");
        int index = filePath.lastIndexOf(File.separator);
        filePath = filePath.substring(0,index)+File.separator + "music_web"+File.separator + "src"+File.separator
        		+"main"+File.separator+folderName+File.separator;
        return filePath;
    }
