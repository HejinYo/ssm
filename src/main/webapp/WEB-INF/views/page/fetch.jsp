...
<body>
	...
	<div id="page-header" class="wrap header">
		<header id="masthead" class="site-header" data-role="banner">
			<div class="hgroup">
				<h1 class="site-title">
					<a class="home-link" href="${basePath }" title="代理IP提取系统" rel="home">代理IP提取系统</a>
				</h1>
...
<div class="wrap fullwidth">
	<div id="content" style="width: auto;">
		<div id="breadcrumbs">
			<a href="${basePath }">首页</a>»»&nbsp; 生成API提取接口
		</div>
		<div id="post-2" class="post-2 page type-page status-publish hentry">
			<div class="entry entry-content">
				
				<form id="fetchForm" class="largeinput" accept-charset="UTF-8" method="POST" target="_blank" action="${basePath }get.html">
					<div class="control-group">
						...
						<div class="controls">
							...
							<span class="star">*&nbsp;</span><a href="${basePath }help.html" target="_blank">数量该怎么填?</a>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="submit" style="margin-top: 22px; ">
						...
						<a href="${basePath }help.html" target="_blank">我提取的代理都能用吗，能用多久？</a>
					</div>
				</form>		
